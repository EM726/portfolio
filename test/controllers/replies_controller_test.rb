...
class RepliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reply" do
    assert_difference('Reply.count') do
      post replies_url, params: { reply: { article_id: @reply.article_id, comment: @reply.comment } }
    end
  ...
  test "should update reply" do
    patch reply_url(@reply), params: { reply: { article_id: @reply.article_id, comment: @reply.comment } }
